...
var GAME_LEVELS = [simpleLevelPlan, secondLevelPlan];
function Level(plan) {
...
//------------------------------------- столкновыние игрока с обьектами
...
function runLevel(level, Display, andThen) {
    ...
    addEventListener("keydown", function checkClick(event) {
        if (event.keyCode == 27) {
                alert("pause");
            }
        });
...
//////////////////////////////////////////////////////////// ВАРИАНТ С ПАУЗОЙ НА ОПРЕДЕЛЕННОЕ ВРЕМЯ 
